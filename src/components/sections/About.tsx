      ...
      <C.SectionWrap>
        ...
        <S.GridBox ref={ref}>
          ...
          <S.CardBox className='js-reveal' style={{ transitionDelay:'100ms' }}>
            <S.Contact>
              <S.AboutItem><S.ItemLabel>email</S.ItemLabel><S.ItemValue><a href="mailto:jaeny96@naver.com">jaeny96@naver.com</a></S.ItemValue></S.AboutItem>
              <S.AboutItem><S.ItemLabel>phone</S.ItemLabel><S.ItemValue>010-6641-9235</S.ItemValue></S.AboutItem>
              <S.AboutItem><S.ItemLabel>birth</S.ItemLabel><S.ItemValue>1996.10.16</S.ItemValue></S.AboutItem>
            </S.Contact>
            {ABOUT_CARDS.map(c => (
              <S.AboutCard key={c.title} data-cur="">
